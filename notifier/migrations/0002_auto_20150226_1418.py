    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default=b'Interno', max_length=20, choices=[(b'Interno', b'Interno'), (b'Phone', b'Extern')])),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.CharField(unique=True, max_length=20, verbose_name=b'work_number')),
                ('externAreaID', models.CharField(max_length=20, null=True, verbose_name=b'ID Externo', blank=True)),
                ('initialDate', models.DateTimeField(verbose_name=b'Fecha Inicial')),
                ('finalDate', models.DateTimeField(verbose_name=b'Fecha Final')),
                ('outboundDate', models.DateField(verbose_name=b'Fecha Outbound')),
                ('affectTime', models.TimeField(null=True, verbose_name=b'Tiempo de Afectacion', blank=True)),
                ('rollbackTime', models.TimeField(null=True, verbose_name=b'Tiempo de Rollback', blank=True)),
                ('department', models.ForeignKey(verbose_name=b'Departamento', to='notifier.Department')),
                ('impact', models.ForeignKey(verbose_name=b'Impacto', to='notifier.Impact')),
                ('municipality', models.ForeignKey(verbose_name=b'Municipio', to='notifier.Municipality')),
                ('ticketArea', models.ForeignKey(verbose_name=b'Area', to='notifier.Area')),
                ('ticketCause', models.ForeignKey(verbose_name=b'Causa', to='notifier.Cause')),
            ],
            options={
            },
            bases=(models.Model,),
