    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affectTime', models.TimeField(null=True, verbose_name=b'affect_time', blank=True)),
                ('rollbackTime', models.TimeField(null=True, verbose_name=b'rollback_time', blank=True)),
